Web UI - Transit Card Management System
This repository contains the Web UI for the Transit Card Management System, a modern React application designed to manage transit cards, customers, trips, and related operations. It communicates with a Python backend.
...
Overview
The Web UI is a modern React application built for managing transit cards, customers, trips, and various related operations. It serves as the frontend interface, communicating seamlessly with a Python backend (which is expected to be run via python main.py). The application prioritizes ease of use and extensibility.
...
Endpoints: The application interacts with various API endpoints including Cards, Customers, Trips, Cases, Tap History, Fare Disputes, and Authentication.
