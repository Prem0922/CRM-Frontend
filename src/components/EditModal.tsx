...
const EditModal: React.FC<EditModalProps> = ({
  ...
  React.useEffect(() => {
    // Reset form data when data changes
    if (data) {
      setFormData(data);
    } else {
      // Clear all form data when creating new item
  ...
  const validateForm = (): boolean => {
    ...
    fields.forEach((field) => {
      ...
      if (!value || (typeof value === 'string' && !value.trim())) {
        ...
        // Enhanced balance validation for non-numeric characters
        ...
        // Enhanced fare validation for non-numeric characters
        if (typeof value === 'string' && value.trim() === '') {
        ...
        // Enhanced tap_time validation for date/time format
        if (typeof value === 'string' && value.trim() === '') {
  ...
  const renderField = (field: Field) => {
    switch (field.type) {
      ...
      default:
        // Use text input for balance and fare fields to allow non-numeric input for validation
